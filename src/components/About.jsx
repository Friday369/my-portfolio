...
const s = {
  ...
  left: {},
  title: { fontSize: 'clamp(1.8rem, 5vw, 2.5rem)', fontWeight: 800, color: '#0a0a0a', letterSpacing: '-1px', lineHeight: 1.1, marginBottom: '1.2rem' },
  ...
  fact: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.9rem 1rem', borderBottom: '2px solid #0a0a0a', flexWrap: 'wrap', gap: '0.5rem' },
  factLabel: { fontFamily: "'Space Mono', monospace", fontSize: '0.6rem', letterSpacing: '0.1em', textTransform: 'uppercase', opacity: 0.6 },
